    ...
    for (buildTypeId in allBuildTypes) {
      ...
      _results.push((function(buildTypeId, buildType) {
        return $.getJSON(buildType.urlForRunningBuilds, function(data) {
          var O_o, branch, branchName, build, buildDoesNotExist, buildInfo, buildKey, buildProjection, builds, displayName, escapedBuildId, id, liForSpecificBuild, running, status, statuses, _k, _l, _len2, _len3, _len4, _m, _ref1, _results1;

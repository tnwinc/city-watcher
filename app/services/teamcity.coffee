...
Ember.Application.initializer
  ...
  initialize: (container, application)->
    container.register 'teamcity:main', TeamCity

    application.inject 'controller', 'teamcity', 'teamcity:main'
    application.inject 'route', 'teamcity', 'teamcity:main'
